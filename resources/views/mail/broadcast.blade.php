...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .header-divider-line { display: inline-block; width: 50px; height: 1px; background: #e5c9c7; }
        .header-divider-dot  { color: #c9a4a4; font-size: 0.7rem; }
        .card {
            background: #fffafa;
            border: 1px solid #e5c9c7;
            border-top: none;
        ...
        .greeting { font-size: 1rem; color: #2d1a1a; margin-bottom: 1.5rem; }
        .greeting em { font-style: normal; font-weight: bold; }
        .body-content { font-size: 0.95rem; line-height: 1.75; color: #3d2222; }
...
<body>
    <div class="wrapper">
        ...
        <div class="footer">
            ...
            <p>
                You are receiving this because you opted in to marketing emails from Chapter of You.<br>
