...
<div class="email-body">
    ...
    {{-- ── Appreciation ── --}}
    <p class="body-para">
        I truly appreciate your patience, and I can't wait for you to experience <em>your</em> <div style="font-family: 'Great Vibes', cursive; font-size: 24px;">signature scent</div>
    </p>
