...
const fetchAddresses = async () => {
    ...
    try {
        ...
        if (!res.ok) {
            lookupError.value = data.message || 'Could not find addresses.';
            return;
        }
        lookupResults.value = data.addresses || [];
        if (!lookupResults.value.length)
            lookupError.value = 'No addresses found.';
    } catch {
        lookupError.value = 'A network error occurred.';
    } finally {
        isLookupLoading.value = false;
    }
};
...
const selectAddress = (a: LookupAddress) => {
    addressForm.line_1 = a.line_1;
    addressForm.line_2 = a.line_2 || '';
    addressForm.city = a.city;
    addressForm.county = a.county || '';
    addressForm.postcode = a.postcode;
    addressForm.country = a.country;
    modalStep.value = 'form';
};
...
const formatAddress = (a: Address): string[] =>
    [a.line_1, a.line_2, a.city, a.county, a.postcode, a.country].filter(
        Boolean,
    ) as string[];
</script>
            ...
            <div class="ap-sections">
                ...
                <section class="ap-card">
                    <div class="ap-card-head">
                        ...
                        >
                            <span
                                v-html="isEditingDetails ? IconX : IconEdit"
                            ></span>
                        ...
                        <div class="field-group">
                            <div class="field">
                                ...
                                <input
                                    ...
                                    :disabled="
                                        !isEditingDetails ||
                                        detailForm.processing
                                    "
                                    class="field-input"
                                />
                                <p
                                    v-if="detailForm.errors.name"
                                    class="field-error"
                                >
                                    {{ detailForm.errors.name }}
                                </p>
                            </div>
                            <div class="field">
                ...
                <section class="ap-card">
                    ...
                    <div v-if="addresses.length" class="address-grid">
                        <div
                            ...
                            class="address-card"
                            :class="{
                                'address-card--default': address.is_default,
                            }"
                        >
                            <!-- petal watermarks -->
                            <span
                ...
                <section class="as-card">
                    ...
                    <div class="as-marketing">
                        ...
                        <label
                            class="as-toggle"
                            :class="{
                                'as-toggle--on': marketingForm.marketing_opt_in,
                            }"
                        >
                            <input
                                type="checkbox"
            ...
            >
                <div class="modal-box">
                    ...
                    <div v-if="modalStep === 'lookup'" class="modal-body">
                        <p class="modal-hint">
                            Enter your postcode or street to find your address
                            quickly.
                        </p>

                        <form
                            @submit.prevent="fetchAddresses"
                            class="lookup-form"
                        >
                            <input
                                type="text"
                            ...
                            <button
                                type="submit"
                                :disabled="
                                    isLookupLoading || lookupQuery.length < 3
                                "
                        ...
                        <p v-if="lookupError" class="field-error mt-2">
                            {{ lookupError }}
                        </p>
                        <p v-if="isLookupLoading" class="lookup-searching">
                            Searching...
                        </p>

                        <div v-if="lookupResults.length" class="lookup-results">
                            <p class="lookup-results-label">
                                Select your address
                            </p>
                            <button
                                v-for="(a, i) in lookupResults"
                                :key="i"
                    ...
                    <!-- Step: Form -->
                    <form
                        v-else-if="modalStep === 'form'"
                        @submit.prevent="saveAddress"
                        class="modal-body"
                    >
                        <div class="field-row">
                            <div class="field">
                                <label for="m-type" class="field-label"
                                    >Address Type</label
                                >
                                <select
                                    id="m-type"
                        ...
                        <div class="field">
                            <label for="m-line1" class="field-label"
                                >Address Line 1</label
                            >
                            <input
                                id="m-line1"
                                type="text"
                                v-model="addressForm.line_1"
                                class="field-input"
                            />
                            <p
                                v-if="addressForm.errors.line_1"
                                class="field-error"
                            >
                                {{ addressForm.errors.line_1 }}
                            </p>
                        </div>

                        <div class="field">
                            <label for="m-line2" class="field-label"
                                >Address Line 2
                        ...
                        <div class="field-row field-row--3">
                            <div class="field">
                                <label for="m-city" class="field-label"
                                    >City</label
                                >
                                <input
                                    id="m-city"
                            ...
                            <div class="field">
                                <label for="m-county" class="field-label"
                                    >County
                                    <span class="field-optional"
                                        >(optional)</span
                                    ></label
                        ...
                        <div class="field">
                            <label for="m-postcode" class="field-label"
                                >Postcode</label
                            >
                            <input
                                id="m-postcode"
                        ...
                        <div class="field">
                            <label for="m-country" class="field-label"
                                >Country</label
                            >
                            <input
                                id="m-country"
