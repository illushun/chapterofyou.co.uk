                ...
                <table class="min-w-full text-sm divide-y divide-copy-light/50">
                    ...
                    <tbody class="divide-y divide-copy-light/50">
                        <tr v-for="product in props.products.data" :key="product.id"
                            ...
                            <td class="px-4 py-3">
                                <img :src="product.images[0]?.image ?? 'https://placehold.co/50x50/333/fff?text=NO'"
                                    :alt="product.name" class="size-10 object-contain border border-copy p-1 rounded">
                            </td>
                            ...
                            <td class="px-4 py-3">
                                ...
                                <span v-if="product.parent_product_id"
                                    class="text-xs text-copy-light ml-2">(Variant)</span>
                            </td>
            ...
            <div class="md:hidden divide-y divide-copy-light/50">
                <div v-for="product in props.products.data" :key="product.id"
                    ...
                    <div class="flex items-start space-x-3 mb-4">
                        <img :src="product.images[0]?.image ?? 'https://placehold.co/64x64/333/fff?text=NO'"
                            :alt="product.name"
