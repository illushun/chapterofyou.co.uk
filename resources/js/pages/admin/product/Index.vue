...
const { paginate, confirmDelete, duplicateRecord, fmtCurrency, stockLabel } =
    useAdmin();
</script>
    ...
    <AdminLayout>
        ...
        <div class="adm-header">
            <div>
                ...
                <p class="adm-sub">
                    {{ products.total }} products in catalogue
                </p>
            </div>
            <Link
                    ...
                    <tbody>
                        ...
                        >
                            ...
                            <td class="adm-td">
                                ...
                                <span
                                    v-if="p.parent_product_id"
                                    class="adm-badge adm-badge--lav pi-variant"
                                    >Variant</span
                                >
                            </td>
