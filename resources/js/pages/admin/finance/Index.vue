...
const submitForm = () => {
    if (modalMode.value === 'create') {
        ...
        form.put(
            route('admin.finance.cost-items.update', editingItem.value.id),
            { onSuccess: closeModal },
        );
    }
};
...
const deleteItem = (item: CostItem) => {
    if (
        !confirm(
            `Delete "${item.name}"? This will also remove it from any product cost breakdowns.`,
        )
    )
        return;
    ...
    <AdminLayout>
        ...
        <div class="adm-header">
            <div>
                ...
                <p class="adm-sub">
                    Track the cost of every supply used in your products.
                </p>
            </div>
            <div style="display: flex; gap: 0.6rem; align-items: center">
                <Link
                    :href="route('admin.finance.products')"
        ...
        <div class="adm-card adm-card--flush">
                    ...
                    <tbody>
                        ...
                        >
                            <td class="adm-td">
                                ...
                                <p v-if="item.notes" class="fi-item-note">
                                    {{ item.notes }}
                                </p>
                            </td>
                            <td class="adm-td">
                            ...
                            <td class="adm-td adm-td--right fi-unit-cost">
                ...
                <div v-for="item in items" :key="item.id" class="adm-mob-card">
                    <div class="fi-mob-head">
                        ...
                        <span
                            class="adm-badge"
                            :class="
                                categoryBadge[item.category] ?? 'adm-badge--off'
                            "
                        >
                    ...
                    <div class="fi-mob-meta">
                        ...
                        <div>
                            ...
                            <p class="fi-mob-val fi-unit-cost">
                                {{ fmtCurrency(item.unit_cost) }}
                            </p>
                        </div>
                    </div>
            ...
            <div v-if="!items.length" class="adm-empty">
                ...
                <p class="adm-empty-sub">
                    Add your first supply to start tracking costs.
                </p>
                <button @click="openCreate" class="adm-btn adm-btn--primary">
                    Add Item
                </button>
            </div>
        </div>
                    ...
                    <form @submit.prevent="submitForm" class="fi-modal-body">
                        <div class="adm-field-row">
                            <div class="adm-field" style="flex: 2">
                                <label class="adm-label"
                                    >Name <span class="fi-req">*</span></label
                                >
                                <input
                                    v-model="form.name"
                                    type="text"
                                    class="adm-input"
                                    :class="{
                                        'adm-input--err': form.errors.name,
                                    }"
                            ...
                            <div class="adm-field">
                                <label class="adm-label"
                                    >Category
                                    <span class="fi-req">*</span></label
                                >
                                <select
                                    v-model="form.category"
                                    class="adm-select"
                                    :class="{
                                        'adm-select--err': form.errors.category,
                                    }"
                                >
                                    <option
                                        v-for="(label, key) in categories"
                                ...
                                <p v-if="form.errors.category" class="adm-err">
                        ...
                        <div class="adm-field-row">
                            ...
                            <div class="adm-field">
                                ...
                                <input
                                    v-model="form.supplier_url"
                                    type="url"
                                    class="adm-input"
                                    :class="{
                                        'adm-input--err':
                                            form.errors.supplier_url,
                                    }"
                                    placeholder="https://…"
                                />
                                <p
                                    v-if="form.errors.supplier_url"
                                    class="adm-err"
                                >
                                    {{ form.errors.supplier_url }}
                                </p>
                        ...
                        <div class="fi-three-col">
                            ...
                            <div class="adm-field">
                                ...
                                <input
                                    ...
                                    :class="{
                                        'adm-input--err':
                                            form.errors.purchase_qty,
                                    }"
                                    placeholder="e.g. 50"
                                />
                                <p
                                    v-if="form.errors.purchase_qty"
                                    class="adm-err"
                                >
                                    {{ form.errors.purchase_qty }}
                                </p>
