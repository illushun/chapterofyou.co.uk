...
const disconnect = () => {
    if (
        confirm(
            'Disconnect your Etsy shop? Existing imported orders will remain.',
        )
    ) {
    ...
    <AdminLayout>
        ...
        <div class="adm-header">
            <div>
                ...
                <p class="adm-sub">
                    Connect external platforms to sync products and import
                    orders
                </p>
            </div>
        </div>
        ...
        <div class="adm-card mkp-etsy-card">
            ...
            <div class="mkp-card-head">
                ...
                <div class="mkp-card-meta">
                    ...
                    <p class="mkp-card-desc">
                        Export products &amp; import orders from your Etsy shop
                    </p>
                </div>
                <span
                    v-if="connection"
                    class="adm-badge adm-badge--on mkp-status-badge"
                    >Connected</span
                >
                <span v-else class="adm-badge adm-badge--off mkp-status-badge"
                    >Not connected</span
                >
            </div>
            ...
            <template v-if="connection">
                ...
                <div class="adm-stats mkp-stats">
                    ...
                    <div class="adm-stat">
                        <div class="adm-stat-val mkp-import-date">
                            {{ formatDate(stats?.last_import ?? null) }}
                        </div>
                ...
                <p class="mkp-shop-line">
                    ...
                    <span v-if="connection.shop_id" class="mkp-shop-id"
                        >#{{ connection.shop_id }}</span
                    >
                </p>
                ...
                <div class="mkp-shipping-profile">
                    ...
                    <template v-if="shipping_profiles.length">
                        <div class="mkp-shipping-row">
                            <select
                                v-model="selectedShippingProfile"
                                class="adm-input mkp-shipping-select"
                            >
                            ...
                            <button
                                @click="saveShippingProfile"
                                class="adm-btn adm-btn--primary mkp-shipping-save"
                            >
                                Save
                            </button>
                        </div>
                    ...
                    <p v-else class="adm-sub mkp-shipping-empty">
                        No shipping profiles found. Reconnect your shop to fetch
                        them.
                    </p>
                </div>
                ...
                <div class="mkp-actions">
                    <Link
                        :href="route('admin.marketplace.etsy.products')"
                    ...
                    <button
                        @click="disconnect"
                        class="adm-btn adm-btn--danger mkp-disconnect-btn"
                    >
                        Disconnect
                    </button>
                </div>
            ...
            <template v-else>
                <p class="mkp-connect-desc">
                    Connect your Etsy shop to export products as draft listings
                    and automatically import new orders. You'll be redirected to
                    Etsy to authorise access.
                </p>
                <a
                    :href="route('admin.marketplace.etsy.connect')"
                    class="adm-btn mkp-connect-btn"
                >
                    Connect Etsy Shop
                </a>
                ...
                <div class="mkp-manual-divider">
                    <span
                        >or use manual CSV tools while waiting for API
                        approval</span
                    >
                </div>
                ...
                <div class="mkp-manual-actions">
                    ...
                    <Link
                        :href="
                            route('admin.marketplace.etsy.orders.import-csv')
                        "
                        class="adm-btn adm-btn--ghost"
                    >
...
.mkp-connect-btn:hover:not(:disabled) {
    opacity: 0.88;
}
