                ...
                <table class="min-w-full text-sm divide-y divide-copy-light/50">
                    ...
                    <tbody class="divide-y divide-copy-light/50">
                        <tr v-for="cart in carts.data" :key="cart.id" class="hover:bg-secondary-light transition">
                            ...
                            <td class="px-4 py-3">
                                <span v-if="cart.user">
                                    <Link :href="route('admin.users.show', cart.user.id)" class="hover:underline">{{ cart.user.name }}</Link><br>
                                    <span class="text-xs text-copy-light">{{ cart.user.email }}</span>
                                </span>
                                <span v-else class="text-copy-light text-xs break-all">{{ cart.session_id ? `Session ID: ${cart.session_id}` : 'N/A' }}</span>
                            </td>
                            ...
                            <td class="px-4 py-3 text-right whitespace-nowrap">
                                <Link :href="route('admin.carts.show', cart.id)" class="text-blue-500 hover:text-blue-700 transition font-semibold">
                                    View Contents
                                </Link>
                            </td>
                        </tr>
