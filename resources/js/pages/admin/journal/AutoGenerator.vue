...
function save() {
    form.transform((d) => ({ ...d, _method: 'PUT' })).post(
        route('admin.journal.auto-generator.update'),
        { preserveScroll: true },
    );
}
    ...
    <AdminLayout>
        <div class="adm-header">
            <div>
                ...
                <p class="adm-sub">
                    Automatically write and publish SEO-optimised journal posts
                    on a schedule.
                </p>
            </div>
            <button
            ...
            <div class="je-main">
                ...
                <div class="adm-card">
                    ...
                    <div class="adm-field">
                        ...
                        <div class="adm-status-btns">
                            <button
                                ...
                                :class="
                                    !form.enabled ? 'adm-status-btn--off' : ''
                                "
                            >
                                Off
                            </button>
                            <button
                                ...
                                class="adm-status-btn"
                                :class="
                                    form.enabled ? 'adm-status-btn--on' : ''
                                "
                            >
                                On
                            </button>
                        ...
                        <p class="adm-field-note">
                            When on, a new post is written and published
                            automatically on the schedule below.
                        </p>
                    </div>
                    ...
                    <div v-if="form.frequency === 'monthly'" class="adm-field">
                        ...
                        <p class="adm-field-note">
                            If a month is shorter than this (e.g. 31st in
                            February), the post runs on the last day of that
                            month instead.
                        </p>
                    </div>
                    ...
                    <div class="adm-field">
                        ...
                        >
                        <textarea
                            v-model="form.topic_notes"
                            rows="3"
                            class="adm-textarea"
                            maxlength="1000"
                            placeholder="e.g. Focus on gifting season, mention our new scent range…"
                        ></textarea>
                        <p class="adm-field-note">
                            {{ form.topic_notes.length }}/1000
                        </p>
                    </div>
                ...
                <div class="adm-card">
                    ...
                    >
                        ...
                        >
                            <Link
                                :href="route('admin.journal.show', post.id)"
                                style="color: var(--adm-ink); font-weight: 600"
                                >{{ post.title }}</Link
                            >
                            <span
                                style="
                    ...
                    <p
                        v-else
                        style="color: var(--adm-ink-dim); font-style: italic"
                    >
            ...
            <div class="je-sidebar">
                <div class="adm-card">
                    ...
                    <div class="adm-field">
                        ...
                        <p>
                            {{ settings.last_generated_at ?? 'Never run yet' }}
                        </p>
                    </div>
                    ...
                    <p v-if="settings.last_error" class="adm-field-error">
                        {{ settings.last_error }}
                    </p>
                </div>
            </div>
