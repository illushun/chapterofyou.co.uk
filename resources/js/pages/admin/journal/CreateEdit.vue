...
const toolbarActions = [
    ...
    {
        label: 'Quote',
        action: () => insertMarkup('<blockquote>', '</blockquote>'),
    },
    {
        label: 'HR',
        action: () => {
...
function save(status: 'draft' | 'published') {
    ...
    if (props.isEditing) {
        form.transform((d) => ({ ...d, _method: 'PUT' })).post(
            route('admin.journal.update', props.post!.id),
            {
                forceFormData: true,
                onFinish: () => {
            ...
            <div class="je-main">
                ...
                <div class="adm-card">
                    <div class="adm-field">
                        ...
                        />
                        <p v-if="form.errors.title" class="adm-field-error">
                            {{ form.errors.title }}
                        </p>
                    </div>
                ...
                <div class="adm-card adm-card--flush">
                    <div class="je-toolbar">
                        <button
                            v-for="t in toolbarActions"
                            :key="t.label"
                            type="button"
                            @click="t.action"
                            class="je-toolbar-btn"
                            :title="t.label"
                        >
                            {{ t.label }}
                        </button>
                    ...
                    <textarea
                        ...
                        v-model="form.body"
                        rows="28"
                        class="je-body-editor"
                        placeholder="Write your article in HTML. Use the toolbar above for quick formatting.&#10;&#10;Tip: use <h2> and <h3> for headings, <p> for paragraphs, <strong> for bold."
                    ></textarea>
                    <p
                        v-if="form.errors.body"
                        class="adm-field-error"
                ...
                <div class="adm-card">
                    <button
                        type="button"
                        class="je-seo-toggle"
                        @click="showSeoPanel = !showSeoPanel"
                    >
                        <span>SEO Settings</span>
                        <svg
                            :style="
                                showSeoPanel ? 'transform:rotate(180deg)' : ''
                            "
                            width="14"
                            height="14"
                            viewBox="0 0 24 24"
                    ...
                    <div v-if="showSeoPanel" class="je-seo-body">
                        <div class="adm-field">
                            ...
                            <input
                                ...
                                maxlength="60"
                                :placeholder="
                                    form.title || 'Auto-filled from title'
                                "
                            />
                        </div>
                        <div class="adm-field">
                            ...
                            <textarea
                                ...
                                maxlength="160"
                                :placeholder="
                                    form.excerpt || 'Auto-filled from excerpt'
                                "
                            ></textarea>
                        </div>
                        ...
                        <div class="je-serp-preview">
                            ...
                            <p class="je-serp-url">
                                chapterofyou.co.uk › journal ›
                                {{ form.slug || 'post-slug' }}
                            </p>
                            <p class="je-serp-desc">
                                {{
                                    form.meta_description ||
                                    form.excerpt ||
                                    'Post excerpt or meta description will appear here.'
                                }}
                            </p>
                        </div>
                    </div>
                ...
                <div v-if="!isEditing && suggested?.length" class="adm-card">
                    <p
                        ...
                        style="font-size: 0.78rem; margin-bottom: 0.75rem"
                    >
                        <Lightbulb :size="13" :stroke-width="2" /> SEO topic
                        ideas
                    </p>
            ...
            <div class="je-sidebar">
                ...
                <div class="adm-card">
                    ...
                    <label class="adm-upload-zone" v-else>
                        ...
                        <p class="adm-upload-note">
                            Click to upload cover image<br /><span
                                >JPEG, PNG or WebP · max 4MB</span
                            >
                        </p>
                    </label>
                </div>
                ...
                <div class="adm-card">
                    ...
                    <div class="adm-field">
                        ...
                        />
                        <p class="adm-field-note">
                            Comma-separated. Used for related posts.
                        </p>
                    </div>
                </div>
                ...
                <div v-if="products?.length" class="adm-card">
                    ...
                    <p class="adm-field-note" style="margin-bottom: 0.6rem">
                        Shown on the live post as "Shop the scents in this
                        post". Pick any products genuinely mentioned or
                        relevant.
                    </p>
