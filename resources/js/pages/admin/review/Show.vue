...
const updateStatus = (newStatus: Review['status']) => {
    ...
    statusForm.put(route('admin.reviews.update', props.review.id), {
        preserveScroll: true,
    });
};

const saveReply = () => {
    replyForm.post(route('admin.reviews.reply', props.review.id), {
        preserveScroll: true,
    });
};
...
<template>
    <AdminLayout>
        <Head :title="`Review #${review.id} : Admin`" />
        ...
        <div class="rs-header">
            ...
            <span class="rs-badge" :class="statusClass(review.status)">{{
                review.status
            }}</span>
        </div>
            ...
            <div class="rs-left">
                ...
                <div class="rs-card">
                    ...
                    <div v-if="review.review_images?.length" class="rs-images">
                        ...
                        <div class="rs-image-row">
                            <img
                                v-for="(img, i) in review.review_images"
                                :key="i"
                                :src="img"
                ...
                <div class="rs-card">
                    <h2 class="rs-card-title">
                        Admin Reply
                        <span v-if="hasReply" class="rs-reply-badge"
                            >Published</span
                        >
                        <span v-else class="rs-reply-badge rs-reply-badge--none"
                            >No reply</span
                        >
                    </h2>

                    <p class="rs-reply-help">
                        Your reply will appear publicly beneath this review on
                        the product page, attributed as "Chapter of You".
                        {{
                    ...
                    <div class="rs-reply-form">
                        ...
                        <div class="rs-reply-actions">
                            <span class="rs-char-count"
                                >{{ replyForm.admin_reply.length }} / 1000</span
                            >
                ...
                <div class="rs-card">
                    ...
                    <div class="rs-detail-grid">
                        ...
                        <div class="rs-detail-item">
                            ...
                            <Link
                                :href="
                                    route('products.show', review.product.id)
                                "
                                target="_blank"
                                class="rs-ext-link"
                            >
                ...
                <div class="rs-card">
                    ...
                    <div class="rs-detail-grid">
                        ...
                        <div class="rs-detail-item">
                            ...
                            <Link
                                :href="
                                    route('admin.users.show', review.user.id)
                                "
                                class="rs-ext-link"
                            >
                                View Profile
                ...
                <div class="rs-actions-card">
                    ...
                    <div class="rs-action-btns">
                        <button
                            ...
                            :class="{
                                'rs-btn--current': review.status === 'approved',
                            }"
                        >
                            <svg
                                width="14"
                        ...
                        <button
                            ...
                            "
                            class="rs-btn rs-btn--pending"
                            :class="{
                                'rs-btn--current': review.status === 'pending',
                            }"
                        >
                            <svg
                                width="14"
                        ...
                        <button
                            ...
                            :class="{
                                'rs-btn--current': review.status === 'rejected',
                            }"
                        >
                            <svg
                                width="14"
                    ...
                    <p class="rs-moderation-note">
                        Only <strong>approved</strong> reviews are shown
...
.rs-message {
    ...
    line-height: 1.7;
    color: var(--adm-ink);
    border-left: 3px solid var(--adm-stamp);
    padding-left: 1rem;
    margin: 0 0 1rem;
    font-style: italic;
}
